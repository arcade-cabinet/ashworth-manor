...
- close_file(path: String) -> int - Closes the file at the given `path`, discarding any unsaved changes. Returns `OK` on success or `ERR_FILE_NOT_FOUND` if the file is not found.
