...
- _profiling_stop()
- _reload_all_scripts()
- _reload_scripts(scripts: Array, soft_reload: bool) - Reloads all `scripts` from disk and the specifics of how that happens is ScriptLanguageExtension specific.
- _reload_tool_script(script: Script, soft_reload: bool) - Reloads the given `script` from disk and the specifics of how that happens is ScriptLanguageExtension specific.
