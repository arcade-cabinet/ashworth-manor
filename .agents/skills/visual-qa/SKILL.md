...
description: |
  ...
  Supports Gemini Flash (default), native Codex vision, or both with aggregated verdict.
context: fork
---
...
- **`--native`** flag in arguments: Use Codex vision — read every image with the Read tool, analyze directly. Do NOT run the Gemini script.
